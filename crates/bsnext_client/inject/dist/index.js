...
var require_timer = __commonJS({
  "../node_modules/livereload-js/src/timer.js"(exports) {
    ...
    Timer2.start = (timeout, func) => setTimeout(func, timeout);
...
var WebSocketSubject = function(_super) {
  ...
  WebSocketSubject2.prototype._connectSocket = function() {
    ...
    var socket2 = null;
    try {
      socket2 = protocol ? new WebSocketCtor(url2, protocol) : new WebSocketCtor(url2);
    ...
    socket2.onopen = function(evt) {
      ...
      _this.destination = Subscriber.create(function(x) {
        ...
        if (err && err.code) {
          socket2.close(err.code, err.reason);
        } else {
